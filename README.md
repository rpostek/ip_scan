...
## Funkcje
1. **Name** - nazwa komputera. Pobierana komendą *gwmi win32_computersystem*.
...
1. **User Name** - nazwa aktualnie zalogowanego użytkownika. Pobierana komendą *gwmi win32_computersystem*.
...
1. **System Family** - ... Pobierana komendą *gwmi win32_computersystem*.
1. **Logical Processors** - liczba procesorów logicznych komputera. Pobierana komendą *gwmi win32_computersystem*.
1. **Memory** - ilość pamięci fizycznej komputera (dostepnej dla systemu operacyjnego). Pobierana komendą *gwmi win32_computersystem*.
